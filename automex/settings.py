...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '.automex.com']
...
INSTALLED_APPS = [
    ...
    'blog',
    'clients',
    # Remove 'automex' from here as it's your project name, not an app
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'services.context_processors.services_processor',  # Add this
            ],
        },
    },
]
...
DEFAULT_FROM_EMAIL = 'automextechnologies.com'
